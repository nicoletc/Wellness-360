...
<body>
    ...
    <script>
        // Base URLs for redirects (generated by PHP to ensure correct paths)
        const baseUrl = '<?php echo app_url(""); ?>';
        const paymentSuccessUrl = '<?php echo app_url("View/payment_success.php"); ?>';
        const checkoutUrl = '<?php echo app_url("View/checkout.php"); ?>';
        const cartUrl = '<?php echo app_url("View/cart.php"); ?>';
