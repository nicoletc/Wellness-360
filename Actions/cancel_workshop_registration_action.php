<?php
/**
 * Cancel Workshop Registration Action
 * Handles cancellation of workshop registration for customers
 */
...
if (!is_logged_in()) {
    ...
    echo json_encode(['status' => false, 'message' => 'Please log in to cancel workshop registration.']);
    exit;
}
...
try {
    ...
    $result = $controller->cancel_ctr($workshop_id, $customer_id);
