<?php
/**
 * Update Workshop Action
 * Handles updating an existing workshop
 */
...
$workshop_image = $_POST['workshop_image'] ?? '';
...
// Create controller instance and update workshop
$controller = new workshop_controller();
$result = $controller->update_workshop_ctr($data);
